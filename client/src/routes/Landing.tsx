...
export default function Landing() {
	return (
		<div className="min-h-screen bg-white text-gray-800 antialiased">
			...
			{/* Hero Section */}
            <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
				<div>
					<AnimatedText 
                    ...
                    <div className="mt-8 flex flex-wrap gap-3 sm:gap-4">
						<Link to="/signup">
                            <button className="w-full sm:w-auto px-6 py-3 text-white bg-gradient-to-r from-emerald-400 to-teal-400 rounded-md font-medium shadow hover:opacity-90 transition">Use It Free</button>
						</Link>
						<Link to="/login">
                            <button className="w-full sm:w-auto px-6 py-3 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 transition">Sign In</button>
						</Link>
			</div>
					<p className="mt-3 text-sm text-gray-500">Instant access. No sign-up walls. No ads.</p>
				</div>
				
                <FadeInSection className="bg-white rounded-3xl shadow-xl p-4 sm:p-6 border border-gray-100">
			...
			{/* Why Free */}
            <FadeInSection className="py-16 sm:py-20 bg-gradient-to-r from-gray-50 via-white to-gray-50 border-t border-gray-100">
			...
			{/* Community */}
            <FadeInSection className="py-16 sm:py-20 bg-white border-t border-gray-100">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
			...
			{/* CTA */}
            <FadeInSection className="text-center py-20 sm:py-24 bg-gradient-to-r from-emerald-50 via-teal-50 to-lime-50 border-t border-gray-100">
            ...
            <footer className="border-t border-gray-200 bg-white py-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
